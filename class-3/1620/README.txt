...
풀이
----
 - 대량의 데이터를 빠르게 탐색하기 위해 탐색속도가 빠른 map 자료구조를 이용하였다.
 - 입력이 정수인지 문자열인지 판단하는 함수인 isdigit을 사용하기 위해 cctype 헤더파일을 include하였다.
 - 정수를 문자열 형태로 입력받은 후에 정수형으로 변환하는 stoi함수를 사용하기 위해 string 헤더파일을 include 하였다.