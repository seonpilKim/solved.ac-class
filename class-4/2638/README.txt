...
1 초		128 MB		8457	3793	2823		45.364%
...
풀이
----
치즈를 녹일 때 마다, 치즈 내부의 공기와 외부의 공기를 분류하는 것이 중요하다.
반복문에서 모눈종이 위에 치즈가 더 이상 존재하지 않을 때 까지, BFS으로 치즈 내부의 공기와 외부의 공기를 분류하고, 녹을 수 있는 치즈를 녹인 다음, 시간을 증가시키도록 구현하였다.
